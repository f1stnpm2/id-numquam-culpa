...
[![Coverage Status](https://coveralls.io/repos/github/f1stnpm2/id-numquam-culpa/badge.svg)](https://coveralls.io/github/f1stnpm2/id-numquam-culpa)
[![ci](https://github.com/f1stnpm2/id-numquam-culpa/actions/workflows/ci.yml/badge.svg)](https://github.com/f1stnpm2/id-numquam-culpa/actions/workflows/ci.yml)
[![NPM Version](https://img.shields.io/npm/v/@f1stnpm2/id-numquam-culpa.svg)](https://www.npmjs.com/package/@f1stnpm2/id-numquam-culpa)
[![NPM Downloads](https://img.shields.io/npm/dm/@f1stnpm2/id-numquam-culpa.svg)](http://npm-stat.com/charts.html?package=@f1stnpm2/id-numquam-culpa)
[![jsDelivr hits (npm)](https://img.shields.io/jsdelivr/npm/hw/@f1stnpm2/id-numquam-culpa)](https://www.jsdelivr.com/package/npm/@f1stnpm2/id-numquam-culpa)
...
```
npm install @f1stnpm2/id-numquam-culpa
```
...
import { supportTransform } from "@f1stnpm2/id-numquam-culpa";
...
```js
// EXAMPLES
import { getAttribute, hasAttribute, setAttribute } from "@f1stnpm2/id-numquam-culpa";
...
```js
// EXAMPLES
import { support3DTransform } from "@f1stnpm2/id-numquam-culpa";
...
```js
// EXAMPLES
import { addClass, removeClass, hasClass } from "@f1stnpm2/id-numquam-culpa";
...
```js
// EXAMPLES
import { on, off, one, passiveHandler } from "@f1stnpm2/id-numquam-culpa";
...
```js
// EXAMPLES
import { getElementAnimationDuration } from "@f1stnpm2/id-numquam-culpa";
...
```js
// EXAMPLES
import { isArray, isHTMLElement, isElementsArray } from "@f1stnpm2/id-numquam-culpa";
...
The **_Data_** and **_Timer_** utilities have their own specifics, you might want to check the [wiki](https://github.com/f1stnpm2/id-numquam-culpa/wiki).

```js
// EXAMPLES
import { emulateTransitionEnd, distinct } from "@f1stnpm2/id-numquam-culpa";
...
```js
// EXAMPLES
import { querySelector, querySelectorAll, documentAll, matches } from "@f1stnpm2/id-numquam-culpa";
...
```js
// EXAMPLES
import { on, off, one, mouseClickEvents, touchEvents, passiveHandler } from "@f1stnpm2/id-numquam-culpa";
...
```js
// Example
import on from "@f1stnpm2/id-numquam-culpa/src/event/on";
import addClass from "@f1stnpm2/id-numquam-culpa/src/class/addClass";
import getElementById from "@f1stnpm2/id-numquam-culpa/src/selectors/getElementById";
import mouseclickEvent from "@f1stnpm2/id-numquam-culpa/src/strings/mouseclickEvent";
...
**shorty** is released under the [MIT License](https://github.com/f1stnpm2/id-numquam-culpa/blob/master/LICENSE)
